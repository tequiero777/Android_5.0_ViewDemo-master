...
import xr.recyclerview.adapter.StaggerAdapter;
...
public class RecyclerActivity extends AppCompatActivity {
    ...
    private void initStaggerAdapterV() {
        ...
        mRecyclerView.setLayoutManager(layoutManger);
        final StaggerAdapter recyclerAdapter = new StaggerAdapter(RecyclerActivity.this, mStaggerData);
        recyclerAdapter.setOnItemClickListener(new StaggerAdapter.OnItemClickListener() {
            @Override
            public void onClick(int position) {
                Toast.makeText(RecyclerActivity.this,mStaggerData.get(position).name,Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onLongClick(int position) {
                mStaggerData.remove(position);
                recyclerAdapter.notifyItemRemoved(position);
                recyclerAdapter.notifyItemRangeChanged(position, mStaggerData.size());
            }
        });
        mRecyclerView.setAdapter(recyclerAdapter);
    }
